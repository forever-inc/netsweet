...
module Netsweet
  class Customer
    ...
    extend Forwardable
    def_delegators :@rvp_customer, :access_role, :external_id, :internal_id, :email, :delete
    ...
    def self.create(attrs = {})
      ...
      if rvp_customer.add
        ...
        raise CustomerNotCreated.new("Customer could not be created. This is error-worthy. Customer: #{attrs}")
      end
    end
