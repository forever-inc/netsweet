...
NetSuite.configure do
  ...
  # often the netsuite servers will hang which would cause a timeout exception
  # to be raised if you don't mind waiting (e.g. processing NS via DJ),
  # increasing the timeout should fix the issue
  read_timeout 100_000

  # you can specify a file or file descriptor to
  # send the log output to (defaults to STDOUT)
